...
| Connect (stub) | — | `src/app/(tabs)/connect.tsx` | [connect](../features/connect.md) | P1 | Partial — tab shell placeholder |
| Connect — discover + profile | Connect tab | `src/app/group/[id].tsx` (planned) | [connect](../features/connect.md) | P1 | Not started — API-complete per research PRD |
...
| Series | `/home/series/:id` | `src/app/series/[id].tsx` | [series](../features/series.md) | P0 | In progress — detail UI; enroll + mockup stats pending |
| Series — enroll | — | `series/[id].tsx` | [series](../features/series.md) | P0 | Not started — use POST `/users/me/series` |
| Routine — SERIES session | edit-routine | `practice/edit-routine/index.tsx` | [series](../features/series.md) §6a, [practice](../features/practice.md) | P0 | Not started — required for series enroll E2E |
| Series — info (About) | `/home/series/:id/info` | TBD | [series](../features/series.md) | P1 | Not started |
| Plans — preview | `/practice/plans/preview` | `src/app/plans/[id].tsx` (planned) | [plans](../features/plans.md) | P0 | Not started — dual route; enrolled users redirect to track |
| Plans — track | `/practice/details` | `src/app/practice/details.tsx` | [plans](../features/plans.md) | P0 | Partial — minimal day nav |
| Group profile | `/home/group/:groupId` | `src/app/group/[id].tsx` (planned) | [connect](../features/connect.md) | P1 | Not started |
...
| Practice | `/practice/*` | `src/app/(tabs)/practice.tsx`, `practice/edit-routine/*`, `practice/details.tsx` | [practice](../features/practice.md) | P1 | In progress — routine partial; missing SERIES session |
...
| `connect` (full feature) | P1 next — tab shell done; discover + group profile planned |
