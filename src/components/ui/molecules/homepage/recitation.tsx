...
export function Recitation() {
    const dummydata = [
        {
            id: '1',
            title: 'The Way of Boddisatva',
            description: 'Prayers to the Buddha',
            image: image,
            duration: '10:00',
        },
        {
            id: '2',
            title: 'Prayerts to the 21 Taras',
            description: 'Prayers to the Taras',
            image: image2,
            duration: '10:00',
        },
        {
            id: '3',
            title: 'Chants of the Heart',
            description: 'Chanting to the Dolma',
            image: image3,
            duration: '10:00',
        },
    ]
