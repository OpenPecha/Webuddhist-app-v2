    ...
    >
      <View className="p-5">
        <View className="flex-row items-start">
          <Text className="flex-1 text-lg font-bold text-white">{"My practices"}</Text>
          <Pressable
            onPress={onPress}
